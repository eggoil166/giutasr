...
export class RemoteReducers {
  ...
  createLobby(code: string, hostRole: Role) {
    const __args = { code, hostRole };
  ...
  onCreateLobby(callback: (ctx: ReducerEventContext, code: string, hostRole: Role) => void) {
    this.connection.onReducer("create_lobby", callback);
  }

  removeOnCreateLobby(callback: (ctx: ReducerEventContext, code: string, hostRole: Role) => void) {
